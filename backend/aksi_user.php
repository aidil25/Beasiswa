...
if (isset($_POST['btnSubmit'])) {
	...
	if(!empty($nama_file)){
		if($tipe_file =="image/jpeg" or $tipe_file == "image/png"){
			...
			$simpan=mysqli_query($koneksi,"INSERT INTO user (nama,username,password,level,email,telepon,photo,hash,aktif) values('$_POST[nama]','$_POST[username]',md5('$_POST[password]'),'$_POST[level]','$email','$_POST[telp]','$nama_file','$token','0')");
