...
<p><a href="?p=admin_panduan&aksi=entri" class="btn btn-primary"> + Tambah data</a></p>
<table class="table table-condensed" id="admin_panduan">
 ...
 include ('koneksi.php');//koneksi ke mysql
  $data=mysqli_query($koneksi,"SELECT * FROM admin_panduan,jenis_beasiswa WHERE admin_panduan.id_jenis_beasiswa=jenis_beasiswa.id_jenis_beasiswa");
  $no=1;
