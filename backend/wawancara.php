...
<p><a href="laporanadministrasi.php" class="btn btn-default"> + Cetak</a></p>
...
<table class="table table-condensed" id="data_mahasiswa">
  ...
  $data=mysqli_query($koneksi,"SELECT * FROM data_mahasiswa INNER JOIN administrasi_data ON data_mahasiswa.no_bp = administrasi_data.nobp 
    WHERE administrasi_data.status ='Lulus' ");
  $no=1;
