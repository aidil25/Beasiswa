							...
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item submenu dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a class="nav-link" href="bidikmisi.php">BidikMisi</a>
                                    </ul>
                                </li> 
								<li class="nav-item submenu dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Panduan</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a class="nav-link" href="bidikmisi.phpxx`">BidikMisi</a>
                                    </ul>
                                </li> 
								<li class="nav-item submenu dropdown">
									<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Jadwal Seleksi</a>
									<ul class="dropdown-menu">
										<li class="nav-item"><a class="nav-link" href="elements.php">BidikMisi</a></li>
									</ul>
								</li> 
								<li class="nav-item submenu dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Persyaratan</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a class="nav-link" href="">BidikMisi</a>
                                    </ul>
                                </li>
								<li class="nav-item active"><a class="nav-link" href="index.php">Masuk</a></li> 
							</ul>
						</div> 
					</div>
            	</nav>
