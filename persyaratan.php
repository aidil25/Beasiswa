					...
					<div class="container">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            <ul class="nav navbar-nav menu_nav ml-auto">
                                ...
                                <li class="nav-item active"><a class="nav-link" href="persyaratan.php">Persyaratan</a></li>
                                <li class="nav-item dropdown"><a class="nav-link" href="masuk.php">Masuk</a></li> 
                            </ul>
                        </div> 
					</div>
            	</nav>
				...
				<div class="banner_inner d-flex align-items-center">
					<div class="container">
						<div class="">
                            ...
                            $data=mysqli_query($koneksi,"SELECT * FROM admin_persyaratan");
                            while ($row=mysqli_fetch_array($data)){
                            ?>
                            <div class="col-lg-9 col-md-9 blog_details">
                                <h2><?php echo $row['judul'] ?></h2>
                                <p class="excert">
                                    <?php echo $row['konten_persyaratan'] ?>
                                </p>
                            </div>
                        <?php }?>
                        </table>
